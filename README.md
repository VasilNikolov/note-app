## За създаване на администраторски потребител

За да създадете потребител от тип администратор е необходимо да отворите конзолата на браузъра и да промените типа на потребителя в users обекта в Local Storage от admin: false на admin:true.
